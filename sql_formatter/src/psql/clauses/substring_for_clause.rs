...
use sql_syntax::PsqlSubstringForClause;
use sql_syntax::PsqlSubstringForClauseFields;
...
impl FormatNodeRule<PsqlSubstringForClause> for FormatPsqlSubstringForClause {
    fn fmt_fields(&self, node: &PsqlSubstringForClause, f: &mut SqlFormatter) -> FormatResult<()> {
