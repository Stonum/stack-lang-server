...
use sql_syntax::PsqlOnConstraintClause;
use sql_syntax::PsqlOnConstraintClauseFields;
...
impl FormatNodeRule<PsqlOnConstraintClause> for FormatPsqlOnConstraintClause {
    fn fmt_fields(&self, node: &PsqlOnConstraintClause, f: &mut SqlFormatter) -> FormatResult<()> {
