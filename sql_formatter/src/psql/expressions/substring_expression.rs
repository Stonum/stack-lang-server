...
use sql_syntax::PsqlSubstringExpression;
use sql_syntax::PsqlSubstringExpressionFields;
...
impl FormatNodeRule<PsqlSubstringExpression> for FormatPsqlSubstringExpression {
    fn fmt_fields(&self, node: &PsqlSubstringExpression, f: &mut SqlFormatter) -> FormatResult<()> {
