...
use sql_syntax::PsqlTildeArraySuffix;
use sql_syntax::PsqlTildeArraySuffixFields;
#[derive(Debug, Clone, Default)]
pub(crate) struct FormatPsqlTildeArraySuffix;
impl FormatNodeRule<PsqlTildeArraySuffix> for FormatPsqlTildeArraySuffix {
    fn fmt_fields(&self, node: &PsqlTildeArraySuffix, f: &mut SqlFormatter) -> FormatResult<()> {
