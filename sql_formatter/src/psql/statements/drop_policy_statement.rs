...
use sql_syntax::PsqlDropPolicyStatement;
use sql_syntax::PsqlDropPolicyStatementFields;
...
impl FormatNodeRule<PsqlDropPolicyStatement> for FormatPsqlDropPolicyStatement {
    fn fmt_fields(&self, node: &PsqlDropPolicyStatement, f: &mut SqlFormatter) -> FormatResult<()> {
