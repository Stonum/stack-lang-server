use crate::prelude::*;
use sql_syntax::SqlTriggerEventList;
#[derive(Debug, Clone, Default)]
pub(crate) struct FormatSqlTriggerEventList;
impl FormatRule<SqlTriggerEventList> for FormatSqlTriggerEventList {
    type Context = SqlFormatContext;
    fn fmt(&self, node: &SqlTriggerEventList, f: &mut SqlFormatter) -> FormatResult<()> {
