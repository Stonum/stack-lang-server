...
use sql_syntax::SqlCreateFunctionStatement;
use sql_syntax::SqlCreateFunctionStatementFields;
#[derive(Debug, Clone, Default)]
pub(crate) struct FormatSqlCreateFunctionStatement;
impl FormatNodeRule<SqlCreateFunctionStatement> for FormatSqlCreateFunctionStatement {
    fn fmt_fields(
        &self,
        node: &SqlCreateFunctionStatement,
        f: &mut SqlFormatter,
    ) -> FormatResult<()> {
        let SqlCreateFunctionStatementFields {
            create_token,
            or_token,
            replace_token,
            kind,
