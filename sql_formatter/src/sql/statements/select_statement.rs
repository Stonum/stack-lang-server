...
use sql_syntax::SqlSelectStatement;
use sql_syntax::SqlSelectStatementFields;
#[derive(Debug, Clone, Default)]
pub(crate) struct FormatSqlSelectStatement;
impl FormatNodeRule<SqlSelectStatement> for FormatSqlSelectStatement {
    fn fmt_fields(&self, node: &SqlSelectStatement, f: &mut SqlFormatter) -> FormatResult<()> {
        let SqlSelectStatementFields {
            with_clause,
            select_clause,
            from_clause,
            where_clause,
