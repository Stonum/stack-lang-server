...
fn format_create_function_parameters_wrap_when_too_long() {
    assert_fmt!(
        r#"--
create function foo(
	really_long_parameter_name_number_one int, really_long_parameter_name_number_two text,
	really_long_parameter_name_number_three boolean, really_long_parameter_name_number_four numeric
) as 'select 1'
"#
    );
}
