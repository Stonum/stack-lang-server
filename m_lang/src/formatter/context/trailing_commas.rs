use super::{MFormatContext, MFormatOptions};
...
impl FormatTrailingCommas {
    ...
    pub fn trailing_separator(&self, options: &MFormatOptions) -> TrailingSeparator {
...
impl Format<MFormatContext> for FormatTrailingCommas {
