...
use crate::syntax::{AnyMArrayElement, MLanguage};
...
where
    N: AstSeparatedList<Language = MLanguage, Node = I>,
    I: ArrayNodeElement + AsFormat<MFormatContext>,
{
