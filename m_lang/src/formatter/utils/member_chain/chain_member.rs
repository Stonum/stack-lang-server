...
use crate::formatter::rules::expressions::computed_member_expression::FormatComputedMemberLookup;
use crate::syntax::{
...
pub(crate) enum ChainMember {
    /// Holds onto a [crate::syntax::MStaticMemberExpression]
    StaticMember { expression: MStaticMemberExpression },

    /// Holds onto a [crate::syntax::MCallExpression]
    CallExpression {
        expression: MCallExpression,
        position: CallExpressionPosition,
    },

    /// Holds onto a [crate::syntax::MComputedMemberExpression]
    ComputedMember {
        expression: MComputedMemberExpression,
    },

    /// Any other node that are not  [crate::syntax::MCallExpression] or [crate::syntax::MStaticMemberExpression]
    /// Are tracked using this variant
    Node(MSyntaxNode),
}

impl ChainMember {
    /// checks if the current node is a [crate::syntax::MCallExpression], or a [crate::syntax::MImportExpression]
