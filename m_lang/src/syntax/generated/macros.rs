        ...
        match $node {
            node => match $crate::syntax::MSyntaxNode::kind(&node) {
                ...
                crate::syntax::MSyntaxKind::M_EMPTY_CLASS_MEMBER => {
                    let $pattern = unsafe { crate::syntax::MEmptyClassMember::new_unchecked(node) };
                    $body
                }
                ...
                crate::syntax::MSyntaxKind::M_LONG_STRING_LITERAL_EXPRESSION => {
                    let $pattern =
                        unsafe { crate::syntax::MLongStringLiteralExpression::new_unchecked(node) };
                    $body
                }
                ...
                crate::syntax::MSyntaxKind::M_ARRAY_ELEMENT_LIST => {
                    let $pattern = unsafe { crate::syntax::MArrayElementList::new_unchecked(node) };
                    $body
                }
                crate::syntax::MSyntaxKind::M_CALL_ARGUMENT_LIST => {
                    let $pattern = unsafe { crate::syntax::MCallArgumentList::new_unchecked(node) };
                    $body
                }
                ...
                crate::syntax::MSyntaxKind::M_OBJECT_MEMBER_LIST => {
                    let $pattern = unsafe { crate::syntax::MObjectMemberList::new_unchecked(node) };
                    $body
                }
