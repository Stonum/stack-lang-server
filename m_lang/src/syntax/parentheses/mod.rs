//! MLang supports parenthesizing expressions, assignments, and TypeScript types.
...
pub trait NeedsParentheses: biome_rowan::AstNode<Language = crate::syntax::MLanguage> {
