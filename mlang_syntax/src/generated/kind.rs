...
pub enum MSyntaxKind {
    ...
    M_ARRAY_ASSIGNMENT_PATTERN_ELEMENT_LIST,
    M_ARRAY_ASSIGNMENT_PATTERN_REST_ELEMENT,
    M_OBJECT_ASSIGNMENT_PATTERN,
    M_OBJECT_ASSIGNMENT_PATTERN_PROPERTY_LIST,
...
impl MSyntaxKind {
    ...
    pub const fn to_string(&self) -> Option<&'static str> {
        let tok = match self {
            ...
            K_KW | T_KW | IN2_KW | INCLUDE_IN_KW => return self.to_ru_keyword(),
