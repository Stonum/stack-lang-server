...
impl MArrayAssignmentPattern {
    ...
    pub fn with_elements(self, element: MArrayAssignmentPatternElementList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MArrayAssignmentPatternRestElement {
    ...
    pub fn with_pattern(self, element: AnyMAssignment) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl MArrayExpression {
    ...
    pub fn with_elements(self, element: MArrayElementList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MCallArguments {
    ...
    pub fn with_args(self, element: MCallArgumentList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MCallExpression {
    pub fn with_callee(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_arguments(self, element: MCallArguments) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MCaseClause {
    ...
    pub fn with_test(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MCatchClause {
    ...
    pub fn with_declaration(self, element: Option<MCatchDeclaration>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_body(self, element: MBlockStatement) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MComputedMemberAssignment {
    ...
    pub fn with_member(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MConditionalExpression {
    ...
    pub fn with_consequent(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
    ...
    pub fn with_alternate(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl MConstructorParameters {
    ...
    pub fn with_parameters(self, element: MConstructorParameterList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MElseClause {
    ...
    pub fn with_alternate(self, element: AnyMStatement) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MExtendsClause {
    ...
    pub fn with_super_class(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MForStatement {
    ...
    pub fn with_initializer(self, element: Option<AnyMForInitializer>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    ...
    pub fn with_test(self, element: Option<AnyMExpression>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            4usize..=4usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    ...
    pub fn with_update(self, element: Option<AnyMExpression>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            6usize..=6usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MForVariableDeclaration {
    pub fn with_var_token(self, element: Option<SyntaxToken>) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(element.map(|element| element.into()))),
        )
    }
    pub fn with_declarator(self, element: MVariableDeclarator) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MFormalParameter {
    ...
    pub fn with_initializer(self, element: Option<MInitializerClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MFunctionDeclaration {
    ...
    pub fn with_inline_token(self, element: Option<SyntaxToken>) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(element.map(|element| element.into()))),
        )
    ...
    pub fn with_id(self, element: AnyMFunctionBinding) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
        )
...
impl MIdentifierExpression {
    pub fn with_name(self, element: MReferenceIdentifier) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl MIfStatement {
    ...
    pub fn with_consequent(self, element: AnyMStatement) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(4usize..=4usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_else_clause(self, element: Option<MElseClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            5usize..=5usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MNewExpression {
    ...
    pub fn with_arguments(self, element: Option<MCallArguments>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MObjectAssignmentPattern {
    ...
    pub fn with_members(self, element: MObjectAssignmentPatternPropertyList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MObjectAssignmentPatternProperty {
    pub fn with_member(self, element: AnyMObjectMemberName) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl MObjectAssignmentPatternRest {
    ...
    pub fn with_target(self, element: AnyMAssignment) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MObjectAssignmentPatternShorthandProperty {
    pub fn with_identifier(self, element: MReferenceIdentifier) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl MObjectExpression {
    ...
    pub fn with_members(self, element: MObjectMemberList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MParameters {
    ...
    pub fn with_items(self, element: MParameterList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MPostUpdateExpression {
    pub fn with_operand(self, element: AnyMAssignment) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl MPropertyObjectMember {
    ...
    pub fn with_value(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MReport {
    pub fn with_name(self, element: MReportName) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_init(self, element: MReportInitList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_default(self, element: Option<MBlockStatement>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_sections(self, element: MReportSectionList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
        )
...
impl MReportFile {
    pub fn with_reports(self, element: MReportList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl MReportName {
    pub fn with_ff2_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl MReportSection {
    pub fn with_name(self, element: MReportSectionName) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl MReportSectionName {
    pub fn with_ff_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl MReturnStatement {
    ...
    pub fn with_argument(self, element: Option<AnyMExpression>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MSpread {
    ...
    pub fn with_argument(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MSwitchStatement {
    ...
    pub fn with_discriminant(self, element: AnyMExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
    ...
    pub fn with_cases(self, element: MSwitchCaseList) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl MTryFinallyStatement {
    ...
    pub fn with_catch_clause(self, element: Option<MCatchClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_finally_clause(self, element: MFinallyClause) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
        )
...
impl MTryStatement {
    ...
    pub fn with_catch_clause(self, element: MCatchClause) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MVariableDeclaration {
    ...
    pub fn with_declarators(self, element: MVariableDeclaratorList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl MVariableDeclarationClause {
    pub fn with_declaration(self, element: MVariableDeclaration) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
