        ...
        match $node {
            node => match $crate::MSyntaxNode::kind(&node) {
                $crate::MSyntaxKind::M_ANNOTATION_ATTRIBUTE => {
                    let $pattern =
                        unsafe { $crate::MAnnotationAttribute::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_ANNOTATION_BINDING => {
                    let $pattern =
                        unsafe { $crate::MAnnotationBinding::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_ANNOTATION_ELEMENT => {
                    let $pattern =
                        unsafe { $crate::MAnnotationElement::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_ASSIGNMENT_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MAssignmentExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_BINARY_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MBinaryExpression::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_CATCH_DECLARATION => {
                    let $pattern =
                        unsafe { $crate::MCatchDeclaration::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_CLASS_DECLARATION => {
                    let $pattern =
                        unsafe { $crate::MClassDeclaration::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_COMPUTED_MEMBER_NAME => {
                    let $pattern =
                        unsafe { $crate::MComputedMemberName::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_CONDITIONAL_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MConditionalExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_CONSTANT_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MConstantExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_CONSTRUCTOR_CLASS_MEMBER => {
                    let $pattern =
                        unsafe { $crate::MConstructorClassMember::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_CONSTRUCTOR_PARAMETERS => {
                    let $pattern =
                        unsafe { $crate::MConstructorParameters::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_CONTINUE_STATEMENT => {
                    let $pattern =
                        unsafe { $crate::MContinueStatement::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_DATE_LITERAL_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MDateLiteralExpression::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_EXPRESSION_SNIPPED => {
                    let $pattern =
                        unsafe { $crate::MExpressionSnipped::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_EXPRESSION_STATEMENT => {
                    let $pattern =
                        unsafe { $crate::MExpressionStatement::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_FOR_ITERATOR_FACTORY => {
                    let $pattern =
                        unsafe { $crate::MForIteratorFactory::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_FOR_ALL_IN_STATEMENT => {
                    let $pattern =
                        unsafe { $crate::MForAllInStatement::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_FOR_VARIABLE_DECLARATION => {
                    let $pattern =
                        unsafe { $crate::MForVariableDeclaration::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_FUNCTION_DECLARATION => {
                    let $pattern =
                        unsafe { $crate::MFunctionDeclaration::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_FUNCTION_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MFunctionExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_GETTER_CLASS_MEMBER => {
                    let $pattern =
                        unsafe { $crate::MGetterClassMember::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_HASH_MAP_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MHashMapExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_HASH_SET_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MHashSetExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_IDENTIFIER_ASSIGNMENT => {
                    let $pattern =
                        unsafe { $crate::MIdentifierAssignment::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_IDENTIFIER_BINDING => {
                    let $pattern =
                        unsafe { $crate::MIdentifierBinding::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_IDENTIFIER_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MIdentifierExpression::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_INITIALIZER_CLAUSE => {
                    let $pattern =
                        unsafe { $crate::MInitializerClause::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_LITERAL_MEMBER_NAME => {
                    let $pattern =
                        unsafe { $crate::MLiteralMemberName::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_LOGICAL_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MLogicalExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_LONG_STRING_LITERAL_EXPRESSION => {
                    let $pattern = unsafe {
                        $crate::MLongStringLiteralExpression::new_unchecked(node)
                    };
                    $body
                }
                $crate::MSyntaxKind::M_METHOD_CLASS_MEMBER => {
                    let $pattern =
                        unsafe { $crate::MMethodClassMember::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_NULL_LITERAL_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MNullLiteralExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_NUMBER_LITERAL_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MNumberLiteralExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_OBJECT_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MObjectExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_PARENTHESIZED_ASSIGNMENT => {
                    let $pattern =
                        unsafe { $crate::MParenthesizedAssignment::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_PARENTHESIZED_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MParenthesizedExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_POST_UPDATE_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MPostUpdateExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_PRE_UPDATE_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MPreUpdateExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_PROPERTY_OBJECT_MEMBER => {
                    let $pattern =
                        unsafe { $crate::MPropertyObjectMember::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_REFERENCE_IDENTIFIER => {
                    let $pattern =
                        unsafe { $crate::MReferenceIdentifier::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_REPORT_SECTION_NAME => {
                    let $pattern =
                        unsafe { $crate::MReportSectionName::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_SEQUENCE_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MSequenceExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_SETTER_CLASS_MEMBER => {
                    let $pattern =
                        unsafe { $crate::MSetterClassMember::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_SHORTHAND_PROPERTY_OBJECT_MEMBER => {
                    let $pattern = unsafe {
                        $crate::MShorthandPropertyObjectMember::new_unchecked(node)
                    };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_STATIC_MEMBER_ASSIGNMENT => {
                    let $pattern =
                        unsafe { $crate::MStaticMemberAssignment::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_STATIC_MEMBER_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MStaticMemberExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_STRING_LITERAL_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MStringLiteralExpression::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_TIME_LITERAL_EXPRESSION => {
                    let $pattern =
                        unsafe { $crate::MTimeLiteralExpression::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_TRY_FINALLY_STATEMENT => {
                    let $pattern =
                        unsafe { $crate::MTryFinallyStatement::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_VARIABLE_DECLARATION => {
                    let $pattern =
                        unsafe { $crate::MVariableDeclaration::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_VARIABLE_DECLARATOR => {
                    let $pattern =
                        unsafe { $crate::MVariableDeclarator::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_VARIABLE_STATEMENT => {
                    let $pattern =
                        unsafe { $crate::MVariableStatement::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_ANNOTATION_ATTRIBUTE_LIST => {
                    let $pattern =
                        unsafe { $crate::MAnnotationAttributeList::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_ANNOTATION_GROUP_LIST => {
                    let $pattern =
                        unsafe { $crate::MAnnotationGroupList::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_ARRAY_ELEMENT_LIST => {
                    let $pattern =
                        unsafe { $crate::MArrayElementList::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_CALL_ARGUMENT_LIST => {
                    let $pattern =
                        unsafe { $crate::MCallArgumentList::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_HASH_MAP_MEMBER_LIST => {
                    let $pattern =
                        unsafe { $crate::MHashMapMemberList::new_unchecked(node) };
                    $body
                }
                $crate::MSyntaxKind::M_HASH_SET_ELEMENT_LIST => {
                    let $pattern =
                        unsafe { $crate::MHashSetElementList::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_OBJECT_MEMBER_LIST => {
                    let $pattern =
                        unsafe { $crate::MObjectMemberList::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_REPORT_SECTION_LIST => {
                    let $pattern =
                        unsafe { $crate::MReportSectionList::new_unchecked(node) };
                    $body
                }
                ...
                $crate::MSyntaxKind::M_VARIABLE_DECLARATOR_LIST => {
                    let $pattern =
                        unsafe { $crate::MVariableDeclaratorList::new_unchecked(node) };
                    $body
                }
                _ => unreachable!(),
            },
