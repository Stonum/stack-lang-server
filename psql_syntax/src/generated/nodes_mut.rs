...
impl PsqlArraySubscriptExpression {
    ...
    pub fn with_index(self, element: AnyPsqlExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlCreateTriggerStatement {
    ...
    pub fn with_function(self, element: PsqlCallExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(12usize..=12usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlDropTableStatement {
    ...
    pub fn with_tables(self, element: PsqlTableNameList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(4usize..=4usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlDropViewStatement {
    ...
    pub fn with_views(self, element: PsqlTableNameList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(4usize..=4usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlFunctionParameter {
    ...
    pub fn with_name(self, element: Option<PsqlName>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl PsqlGrantStatement {
    ...
    pub fn with_objects(self, element: PsqlTableNameList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(4usize..=4usize, once(Some(element.into_syntax().into()))),
        )
    ...
    pub fn with_grantees(self, element: PsqlGranteeList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(6usize..=6usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlReturnsClause {
    ...
    pub fn with_ty(self, element: AnyPsqlReturnsType) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlSubqueryBinding {
    ...
    pub fn with_query(self, element: AnyPsqlSubqueryBody) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlTypeArguments {
    ...
    pub fn with_items(self, element: PsqlTypeArgumentList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlTypeName {
    ...
    pub fn with_args(self, element: Option<PsqlTypeArguments>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl PsqlValuesClause {
    ...
    pub fn with_rows(self, element: PsqlValuesRowList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlWindowFunctionExpression {
    pub fn with_call(self, element: PsqlCallExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    ...
    pub fn with_window(self, element: PsqlWindowSpecification) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlWindowPartitionByClause {
    ...
    pub fn with_items(self, element: PsqlWindowPartitionByItemList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl PsqlWindowSpecification {
    ...
    pub fn with_partition_by_clause(self, element: Option<PsqlWindowPartitionByClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
