...
impl PsqlCreateFunctionStatement {
    ...
    pub fn language_option(&self) -> Option<PsqlLanguageOption> {
...
pub struct PsqlCreateFunctionStatementFields {
    ...
    pub language_option: Option<PsqlLanguageOption>,
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        let result = if current_depth < 16 {
            ...
            f.debug_struct("PsqlCreateFunctionStatement")
                ...
                .field(
                    "language_option",
                    &support::DebugOptionalElement(self.language_option()),
                )
                .field(
                    "semicolon_token",
...
impl AstNode for AnyPsqlReturnsType {
    type Language = Language;
    const KIND_SET: SyntaxKindSet<Language> = PsqlReturnsTableClause::KIND_SET
        .union(PsqlReturnsTriggerClause::KIND_SET)
        .union(PsqlTypeName::KIND_SET);
    fn can_cast(kind: SyntaxKind) -> bool {
        matches!(
            kind,
            PSQL_RETURNS_TABLE_CLAUSE | PSQL_RETURNS_TRIGGER_CLAUSE | PSQL_TYPE_NAME
        )
    }
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
