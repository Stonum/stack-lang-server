...
impl PsqlIntervalExpression {
    ...
    pub fn value(&self) -> SyntaxResult<PsqlStringLiteralExpression> {
        support::required_node(&self.syntax, 1usize)
    }
}
...
pub struct PsqlIntervalExpressionFields {
    ...
    pub value: SyntaxResult<PsqlStringLiteralExpression>,
}
#[derive(Clone, PartialEq, Eq, Hash)]
...
impl From<PsqlIntervalExpression> for AnyPsqlExpression {
...
impl From<AnyPsqlExpression> for SyntaxNode {
    fn from(n: AnyPsqlExpression) -> Self {
        match n {
            ...
            AnyPsqlExpression::PsqlIntervalExpression(it) => it.into(),
