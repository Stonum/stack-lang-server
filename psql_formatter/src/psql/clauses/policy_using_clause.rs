...
use psql_syntax::PsqlPolicyUsingClause;
use psql_syntax::PsqlPolicyUsingClauseFields;
...
impl FormatNodeRule<PsqlPolicyUsingClause> for FormatPsqlPolicyUsingClause {
    fn fmt_fields(&self, node: &PsqlPolicyUsingClause, f: &mut PsqlFormatter) -> FormatResult<()> {
