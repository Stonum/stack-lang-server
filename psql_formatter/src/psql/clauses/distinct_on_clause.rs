...
use psql_syntax::PsqlDistinctOnClause;
use psql_syntax::PsqlDistinctOnClauseFields;
#[derive(Debug, Clone, Default)]
pub(crate) struct FormatPsqlDistinctOnClause;
impl FormatNodeRule<PsqlDistinctOnClause> for FormatPsqlDistinctOnClause {
    fn fmt_fields(&self, node: &PsqlDistinctOnClause, f: &mut PsqlFormatter) -> FormatResult<()> {
