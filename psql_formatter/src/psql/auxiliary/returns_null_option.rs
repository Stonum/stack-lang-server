...
use psql_syntax::PsqlReturnsNullOption;
use psql_syntax::PsqlReturnsNullOptionFields;
...
impl FormatNodeRule<PsqlReturnsNullOption> for FormatPsqlReturnsNullOption {
    fn fmt_fields(&self, node: &PsqlReturnsNullOption, f: &mut PsqlFormatter) -> FormatResult<()> {
