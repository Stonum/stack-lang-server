...
use psql_syntax::PsqlDropViewStatement;
use psql_syntax::PsqlDropViewStatementFields;
#[derive(Debug, Clone, Default)]
pub(crate) struct FormatPsqlDropViewStatement;
impl FormatNodeRule<PsqlDropViewStatement> for FormatPsqlDropViewStatement {
    fn fmt_fields(&self, node: &PsqlDropViewStatement, f: &mut PsqlFormatter) -> FormatResult<()> {
        let PsqlDropViewStatementFields {
            drop_token,
            view_token,
            if_token,
            exists_token,
