use super::prelude::*;
use psql_syntax::{PsqlLanguage, PsqlSyntaxKind};
...
fn handle_create_function_body_comment(
    comment: DecoratedComment<PsqlLanguage>,
) -> CommentPlacement<PsqlLanguage> {
    if comment.enclosing_node().kind() != PsqlSyntaxKind::PSQL_CREATE_FUNCTION_STATEMENT {
