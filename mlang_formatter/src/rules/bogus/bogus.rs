...
impl AsFormat<MFormatContext> for mlang_syntax::MBogus {
    type Format<'a> =
        FormatRefWithRule<'a, mlang_syntax::MBogus, crate::rules::bogus::bogus::FormatMBogus>;
    fn format(&self) -> Self::Format<'_> {
        #![allow(clippy::default_constructed_unit_structs)]
        FormatRefWithRule::new(self, crate::rules::bogus::bogus::FormatMBogus::default())
    }
}
impl IntoFormat<MFormatContext> for mlang_syntax::MBogus {
    type Format =
        FormatOwnedWithRule<mlang_syntax::MBogus, crate::rules::bogus::bogus::FormatMBogus>;
    fn into_format(self) -> Self::Format {
        #![allow(clippy::default_constructed_unit_structs)]
        FormatOwnedWithRule::new(self, crate::rules::bogus::bogus::FormatMBogus::default())
    }
}
