...
//! ```
//!
//! When we track the first [mlang_syntax::MCallExpression], we hold basically all the children,
...
//!
//! 1. as many as [mlang_syntax::MCallExpression] we can find, this cover cases like `something()()().then()`;
//! 2. as many as [mlang_syntax::MComputedMemberExpression] we can find, this cover cases like `something()()[1][3].then()`;
//! 3. as many as consecutive [mlang_syntax::MStaticMemberExpression] or [mlang_syntax::MComputedMemberExpression], this cover cases like `this.items[0].then()`
//!
